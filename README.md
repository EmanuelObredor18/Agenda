...
Por otro lado, también aprendimos a hacer diagramas de flujo basándonos en un algoritmo (el cual simplemente es el programa redactado en un lenguaje de programación).  
### Códigos aprendidos
